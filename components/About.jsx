    ...
    <section id='about' className='w-full mb-[10vh] md:min-h-[60vh] p-4 py-16'>
      <div className='max-w-[1240px] m-auto lg:grid grid-cols-3 gap-8 mt-[10vh] relative z-10'>
        <div className='col-span-2 flex flex-col justify-center'>
          ...
          <p className='py-2 text-gray-600'>
            I became enamoured with the endless possibilities of programming coupled with the ever expanding limits of computing power that seemingly trickles down to each of us. This infatuation sparked my imagination like nothing else: it is why I leaped into three years of Computing Science at SFU and it is why I am here today, currently pursuing a career in Software/Web Development.
          </p>
          <p className='py-2 text-gray-600'>
