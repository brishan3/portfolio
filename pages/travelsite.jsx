  ...
  return (
    <>
      <Head>
          ...
          <meta name="description" content="A promotional website for a fictional travel agency, built using HTML and CSS" />
          <link rel="icon" href="/favicon.ico" />
      </Head>
      <section className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
          <div className='absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] bg-black/50 z-10'/>
          <Image className='absolute z-1' layout='fill' objectFit='cover' src={heroImg} alt='Travel Site website screenshot'/>
