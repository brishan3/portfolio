  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A simple coffee shop website built using HTML and SASS"
        />
        ...
        <section className="w-full overflow-hidden min-h-screen">
          ...
          <div className="max-w-[1240px] mx-auto p-4 grid md:grid-cols-5 gap-8 pt-8">
            <div className="col-span-4">
              ...
              <p>
                <span className="font-bold">Coffeeshop</span> aka.{" "}
                <span className="font-bold italic">Nitro Coffee</span> is a
                static, multi-page coffee shop website built using HTML and CSS,
                displaying various menu items, promotions and contact
                information for the <span className="italic">business</span>.
              </p>
              <p className="mt-2">
