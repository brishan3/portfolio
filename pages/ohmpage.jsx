...
const ohmpage = () => {
  return (
    <>
      <Head>
        <title>Brishan King | Ohmpage</title>
        <meta
          name="description"
          content="A responsive, full-stack web application for use as a customizable home page and link hub"
        />
        ...
        <section className="w-full overflow-hidden min-h-screen">
          ...
          <div className="max-w-[1240px] mx-auto p-4 grid md:grid-cols-5 gap-8 pt-8">
            <div className="col-span-4">
              ...
              <p>
                Inspired by <span className="font-bold">www.weboas.is</span>{" "}
                (which went offline in Feb 2022); a minimal, yet functional
                customizable homepage riddled with interesting links to web
                tools, forums, developer resources, etc. Having used{" "}
                <span className="font-bold">weboas.is</span> religiously on
                every browser and computer I&apos;ve owned over the past 5 years
                as the default homepage, I found many cool, interesting and
                helpful websites via this hub! Now, I have filled that{" "}
                <span className="italic">rather large</span> void with{" "}
                <span className="font-bold">Ohmpage</span>. Sorted into
                categorical icons below the search bar, links are served in a
                dropdown list with pop-out labels offering brief descriptions.
                As well as being a link-hub,{" "}
                <span className="font-bold">Ohmpage</span> offers the user the
                choice to change their background, theme (light/dark) and
                search-engine, with preferences saved locally in browser
                storage.
              </p>
              <p className="mt-2">Stop by, check out the Link Library!</p>
