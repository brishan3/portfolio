  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A promotional website for a fictional band"
        />
        ...
        <section className="w-full overflow-hidden min-h-screen">
          ...
          <div className="max-w-[1240px] mx-auto p-4 grid md:grid-cols-5 gap-8 pt-8">
            <div className="col-span-4">
              ...
              <p>
                <span className="font-bold">Bandsite</span> is a fully
                responsive front-end application for a fictional band by the
                name of &apos;The Bees Knees&apos;. This project was built using
                HTML and vanilla JavaScript, along with Sass for all styling and
                visual responsiveness. Complete with dynamic data being pulled
                from an Express API hosted on Heroku with the added ability to
                be able to post a comment. As this is just for demonstration,
                comments posted to the Heroku API will be wiped/refreshed every
                24 hours.
              </p>
              <p className="mt-2">
